...
export const addToCart = async(req:Request, res:Response)=>{
    try {
        ...
        const{user_id,product_id,orderedQuantity}:orders = req.body

        console.log(req.body);
        


        const result =  (await dbhelper.execute("addToCart", {orderId,user_id, product_id, orderedQuantity})).rowsAffected
